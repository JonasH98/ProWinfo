...
CREATE TABLE IF NOT EXISTS `car_type` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_class_id` (`car_class_id`),
  CONSTRAINT `fk_class_id` FOREIGN KEY (`car_class_id`) REFERENCES `car_class` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

-- Dumping data for table rental_portal.car_type: ~8 rows (approximately)
/*!40000 ALTER TABLE `car_type` DISABLE KEYS */;
REPLACE INTO `car_type` (`id`, `seats`, `doors`, `car_class_id`) VALUES
	(1, '2-3', '2-3', 1),
	(2, '4-5', '2-3', 2),
	(3, '6-7', '2-3', 3),
	(4, '8-9', '2-3', 1),
...
-- Dumping data for table rental_portal.customer: ~201 rows (approximately)
...
REPLACE INTO `customer` (`id`, `full_name`, `address`, `email`, `created_at`, `password`) VALUES
	...
	(202, '123 123', '123', '123', '2021-06-30 20:50:53', '$2b$10$Si05TVRitKSMzQonDOAP0OM7ZL40v0UkdgLFsoql34ai/eKjwjOEC');
...
CREATE TABLE IF NOT EXISTS `reservation` (
  ...
  KEY `car_type_id` (`car_type_id`) USING BTREE,
  CONSTRAINT `FK_reservation_cartype` FOREIGN KEY (`car_type_id`) REFERENCES `car_type` (`id`),
...
REPLACE INTO `reservation` (`id`, `customer_id`, `car_type_id`, `reserved_at`, `rent_from`, `rent_to`) VALUES
	(1, 83, 7, '2017-08-23 15:41:01', '2019-09-26 00:44:17', '2020-08-31 05:12:46'),
	(2, 38, 2, '2018-03-14 21:10:55', '2019-07-11 09:28:36', '2021-12-21 00:25:00'),
	(3, 91, 7, '2018-05-25 23:52:59', '2019-09-12 00:19:57', '2020-10-24 08:38:15'),
	(4, 117, 7, '2017-12-29 20:35:29', '2020-04-06 12:00:52', '2022-02-27 06:22:02'),
	(5, 65, 1, '2018-03-09 12:26:14', '2018-11-22 11:49:03', '2022-05-28 21:43:57'),
	(6, 149, 1, '2018-04-17 15:22:45', '2019-02-19 21:08:01', '2020-09-16 19:25:26'),
	(7, 137, 3, '2018-05-23 14:07:44', '2019-07-03 11:33:00', '2021-08-08 17:58:51'),
	(8, 157, 1, '2017-09-11 18:29:51', '2020-01-17 15:44:04', '2020-08-01 03:48:18'),
	(9, 183, 1, '2017-06-19 04:24:04', '2019-02-21 23:26:55', '2021-06-13 22:10:06'),
	(10, 52, 2, '2018-02-20 22:29:38', '2018-11-17 03:34:52', '2020-12-16 06:14:33'),
	(11, 93, 7, '2017-06-06 20:16:20', '2019-11-14 20:24:42', '2020-09-02 23:01:43'),
	(12, 199, 6, '2018-01-23 05:06:31', '2020-01-17 00:14:57', '2021-06-17 04:02:19'),
	(13, 119, 4, '2017-10-20 14:39:03', '2019-02-13 07:34:22', '2020-09-26 03:48:31'),
	(14, 155, 2, '2018-05-02 09:17:20', '2019-07-13 03:28:01', '2022-04-19 17:35:16'),
	(15, 161, 3, '2018-06-07 06:29:53', '2018-07-05 20:08:01', '2020-10-21 00:32:36'),
	(16, 135, 1, '2017-06-24 01:40:57', '2020-05-13 04:54:50', '2021-06-19 16:49:41'),
	(17, 85, 3, '2017-06-25 14:09:12', '2019-02-12 00:11:40', '2020-08-18 09:10:57'),
	(18, 168, 7, '2017-06-15 02:14:12', '2020-01-13 23:41:47', '2022-04-22 00:57:48'),
	(19, 71, 4, '2018-02-09 20:32:26', '2019-04-07 21:52:50', '2021-02-11 11:31:50'),
	(20, 145, 6, '2018-01-21 00:58:41', '2019-11-05 23:32:23', '2021-08-18 15:49:08'),
	(21, 145, 1, '2018-06-07 18:48:03', '2019-08-24 10:25:08', '2021-05-21 13:50:07'),
	(22, 145, 7, '2017-10-28 22:18:07', '2020-05-05 11:01:34', '2021-05-13 10:08:24'),
	(23, 116, 2, '2017-10-04 20:45:05', '2019-06-12 07:34:21', '2021-01-11 16:13:45'),
	(24, 143, 4, '2018-06-02 17:45:25', '2019-07-29 10:01:40', '2021-07-02 16:13:34'),
	(25, 165, 1, '2018-04-01 20:31:52', '2018-10-22 20:34:09', '2021-12-07 17:59:19'),
	(26, 108, 1, '2017-12-26 03:36:58', '2018-09-13 06:16:47', '2021-02-28 03:15:50'),
	(27, 34, 4, '2017-08-05 17:28:03', '2020-01-19 02:59:03', '2020-08-24 01:38:56'),
	(28, 120, 4, '2017-06-07 12:20:37', '2019-03-11 21:13:50', '2020-11-21 23:50:51'),
	(29, 41, 1, '2017-09-04 14:47:03', '2018-11-09 19:54:02', '2021-11-23 20:14:42'),
	(30, 91, 3, '2017-05-14 02:12:27', '2020-04-05 18:06:59', '2022-04-14 19:36:12'),
	(31, 127, 2, '2017-10-24 08:24:52', '2019-04-03 02:41:38', '2020-08-28 11:15:43'),
	(32, 3, 3, '2017-10-05 04:11:00', '2020-05-11 12:56:23', '2021-08-13 00:27:36'),
	(33, 90, 3, '2017-07-19 08:34:17', '2018-12-28 06:03:21', '2020-08-23 00:00:33'),
	(34, 29, 1, '2017-08-20 09:53:36', '2020-03-02 03:18:48', '2021-12-31 07:31:56'),
	(35, 189, 6, '2017-10-24 00:50:18', '2019-03-12 22:31:26', '2021-05-20 08:52:55'),
	(36, 176, 6, '2018-01-13 13:37:24', '2019-08-04 01:14:12', '2020-08-18 19:39:18'),
	(37, 92, 3, '2017-06-07 15:30:27', '2018-08-30 18:28:51', '2021-02-18 03:22:33'),
	(38, 125, 3, '2017-12-24 20:25:36', '2020-03-29 19:54:56', '2021-07-22 11:36:48'),
	(39, 161, 7, '2017-11-07 13:29:53', '2020-05-16 17:22:05', '2020-12-17 05:28:33'),
	(40, 152, 7, '2017-11-19 00:31:14', '2019-02-28 04:09:37', '2021-11-29 17:26:22'),
	(41, 156, 3, '2018-02-20 11:45:27', '2020-02-25 17:44:21', '2022-04-04 17:49:00'),
	(42, 122, 3, '2017-10-16 02:48:37', '2019-08-01 19:34:54', '2021-05-23 09:54:38'),
	(43, 76, 6, '2017-10-07 15:54:52', '2019-06-26 17:04:23', '2022-01-09 20:30:07'),
	(44, 192, 1, '2017-08-13 19:47:58', '2019-06-07 04:10:37', '2020-09-14 13:30:17'),
	(45, 117, 1, '2017-09-14 19:07:49', '2018-07-12 09:16:35', '2021-09-21 05:10:50'),
	(46, 198, 4, '2018-02-15 04:05:12', '2019-09-23 06:06:51', '2021-03-13 17:10:34'),
	(47, 196, 2, '2018-01-24 15:41:58', '2019-11-26 11:23:37', '2021-07-03 14:24:51'),
	(48, 196, 3, '2017-09-22 06:27:19', '2019-04-28 07:42:36', '2022-03-22 14:46:36'),
	(49, 103, 1, '2017-08-24 06:36:29', '2018-12-06 17:44:01', '2020-12-22 17:19:36'),
	(50, 71, 3, '2018-05-06 21:53:10', '2018-11-22 12:44:04', '2021-03-16 07:18:19'),
	(51, 128, 2, '2017-08-09 22:15:06', '2019-08-27 18:44:13', '2021-01-02 18:55:46'),
	(52, 62, 1, '2018-01-13 13:32:12', '2018-08-07 01:43:24', '2022-02-20 07:51:36'),
	(53, 87, 6, '2018-03-03 21:24:17', '2019-05-29 16:48:22', '2021-02-16 21:34:51'),
	(54, 101, 6, '2018-01-23 19:51:47', '2018-08-23 07:48:51', '2021-11-23 21:09:45'),
	(55, 144, 4, '2017-06-27 09:24:36', '2020-02-01 10:45:12', '2022-04-27 03:03:27'),
	(56, 15, 2, '2018-03-24 23:05:53', '2018-12-28 20:11:24', '2021-06-27 00:30:12'),
	(57, 170, 4, '2018-03-07 03:16:17', '2019-10-09 23:07:59', '2021-03-27 07:45:46'),
	(58, 192, 4, '2018-01-19 10:15:44', '2019-01-01 03:04:07', '2021-07-04 16:59:22'),
	(59, 7, 1, '2017-08-20 20:57:43', '2018-09-03 02:20:46', '2022-04-23 23:58:10'),
	(60, 139, 3, '2018-03-06 13:59:19', '2018-12-31 20:28:48', '2020-12-10 20:11:03'),
	(61, 179, 2, '2017-10-07 17:23:18', '2019-01-17 08:58:42', '2021-07-11 04:33:13'),
	(62, 133, 6, '2017-12-22 04:35:08', '2019-10-17 09:17:14', '2021-11-05 19:26:28'),
	(63, 171, 7, '2017-07-26 18:19:11', '2018-11-21 07:03:58', '2022-05-04 12:55:06'),
	(64, 83, 7, '2018-05-05 19:06:55', '2020-01-17 20:27:31', '2022-02-07 02:50:30'),
	(65, 143, 3, '2017-05-25 18:06:15', '2020-03-14 06:10:16', '2022-06-01 03:53:34'),
	(66, 27, 3, '2017-07-20 19:42:31', '2019-08-23 16:22:55', '2021-08-06 19:18:03'),
	(67, 98, 7, '2017-10-28 14:18:49', '2018-12-23 19:28:10', '2022-01-27 13:09:53'),
	(68, 196, 1, '2017-06-10 21:02:35', '2018-10-11 11:52:33', '2021-09-24 13:00:13'),
	(69, 168, 6, '2018-02-08 17:31:47', '2020-03-11 07:23:19', '2021-12-30 21:52:09'),
	(70, 181, 2, '2017-10-19 23:50:09', '2018-09-10 01:43:33', '2020-12-16 13:54:45'),
	(71, 80, 4, '2017-12-04 16:39:27', '2018-10-24 12:07:05', '2022-05-15 23:38:34'),
	(72, 85, 1, '2018-04-13 05:18:30', '2019-04-23 00:44:25', '2021-02-02 16:05:55'),
	(73, 30, 2, '2018-04-10 12:56:21', '2019-12-24 06:26:43', '2022-06-08 08:31:06'),
	(74, 109, 7, '2018-02-18 08:22:19', '2020-04-21 11:13:43', '2021-07-01 18:30:35'),
	(75, 199, 7, '2017-09-28 06:33:39', '2018-08-20 23:36:14', '2022-05-30 00:12:58'),
	(76, 166, 1, '2017-06-06 21:05:29', '2018-09-07 13:06:35', '2021-12-08 05:56:44'),
	(77, 67, 4, '2017-07-24 18:34:45', '2018-08-17 01:13:37', '2021-06-16 12:40:42'),
	(78, 71, 7, '2018-04-15 01:02:13', '2018-07-30 16:06:01', '2021-08-30 21:17:22'),
	(79, 34, 2, '2017-05-23 16:29:43', '2020-05-01 18:19:17', '2021-12-31 00:02:24'),
	(80, 27, 3, '2017-11-04 23:15:56', '2019-11-24 04:15:30', '2021-10-14 01:07:05'),
	(81, 140, 1, '2017-09-27 13:27:20', '2020-04-13 05:28:49', '2022-02-26 05:50:44'),
	(82, 75, 6, '2018-03-25 02:56:44', '2020-04-10 04:21:45', '2021-07-23 11:44:41'),
	(83, 4, 2, '2018-05-18 23:33:57', '2019-05-18 08:12:46', '2021-11-03 09:03:19'),
	(84, 12, 4, '2017-12-24 18:25:35', '2018-07-04 08:42:54', '2021-07-08 02:21:31'),
	(85, 14, 2, '2017-09-04 13:44:12', '2018-07-20 15:33:10', '2022-02-05 05:03:07'),
	(86, 131, 4, '2018-01-10 08:45:19', '2019-11-29 18:46:23', '2021-04-24 11:13:48'),
	(87, 147, 1, '2017-07-31 10:17:27', '2018-09-06 15:19:33', '2021-01-24 01:03:31'),
	(88, 188, 2, '2017-12-21 18:10:49', '2019-04-03 20:49:22', '2021-08-27 03:20:12'),
	(89, 184, 3, '2018-04-20 09:48:07', '2020-04-20 08:54:26', '2020-08-22 22:24:56'),
	(90, 79, 6, '2018-03-26 16:36:37', '2018-09-19 18:58:00', '2021-12-20 15:24:44'),
	(91, 51, 7, '2018-05-23 01:35:42', '2019-11-06 00:20:47', '2022-04-27 05:02:00'),
	(92, 116, 6, '2018-06-08 16:35:13', '2019-03-16 16:06:04', '2020-07-26 23:46:18'),
	(93, 26, 2, '2017-10-19 21:38:01', '2019-06-21 01:38:05', '2021-02-23 17:22:34'),
	(94, 65, 1, '2018-02-17 18:14:09', '2019-09-22 16:45:48', '2021-11-05 15:21:54'),
	(95, 175, 4, '2017-10-12 02:48:20', '2019-09-17 14:42:03', '2021-05-26 20:54:11'),
	(96, 94, 6, '2017-06-01 13:14:34', '2019-05-14 21:48:41', '2020-12-07 12:49:43'),
	(97, 143, 6, '2018-05-15 22:05:54', '2019-02-10 23:04:00', '2021-12-13 10:01:10'),
	...
	(100, 185, 1, '2017-10-26 16:56:28', '2019-02-11 18:59:17', '2020-12-27 11:45:59');
